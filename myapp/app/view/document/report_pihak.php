                    ...
                    <div class="iq-card-body">
                        <div class="table-responsive">
                            ...
                            <table id="user-list-table" class="table table-striped table-bordered mt-4" role="grid" aria-describedby="user-list-page-info">
                                <thead>
                                    <tr>
										<th class="text-center" width="5%">Users</th>
                                        ...
                                        <tr>
											<td>
												<div class="flex align-items-center" "text-center">
													<img class="rounded img-fluid avatar-40"  src="<?php echo APP_PATH; ?>/images/user/06.jpg" alt="profile"><br>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('exportPdf').addEventListener('click', function () {
            ...
            let content = [];
            const tableHeaders = [];
            const headerCells = table.getElementsByTagName('thead')[0].getElementsByTagName('tr')[0].getElementsByTagName('th');

            // Ambil header tabel
            for (let i = 0; i < headerCells.length; i++) {
                tableHeaders.push(headerCells[i].textContent);
            }
            content.push(tableHeaders);

            // Ambil isi tabel
            for (let i = 0; i < rows.length; i++) {
                const cells = rows[i].getElementsByTagName('td');
                if (rows[i].style.display !== 'none') { // Hanya ambil yang ditampilkan
                    const rowData = [];
                    for (let j = 0; j < cells.length; j++) {
