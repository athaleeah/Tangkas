                            ...
                            <table id="user-list-table" class="table table-striped table-bordered mt-4" role="grid" aria-describedby="user-list-page-info">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="40%">Detail Tambahan</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($data['datareport'] as $report) : ?>
                                        <tr>
											...
											<td>
												<div class="flex align-items-center">
													<i class="ri-calendar-line"> <?= $report['tanggal_kejadian'] ?></i><br>
													...
													<i class="ri-shield-user-line"> Status Laporan : <?= $report['status_laporan'] ?></i><br>
										  ...
										  <td class="text-center">
                                                ...
                                                <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="Edit" type="button" onclick="
                                                    $('#report_id').val('<?=$report['id_laporan'];?>');
                                                    $('#report_judul').val('<?=$report['judul'];?>');
                                                    $('#report_desc').val('<?=$report['deskripsi_pengaduan'];?>');
                                                    $('#report_lokasi').val('<?=$report['lokasi'];?>');
                                                    $('#report_tanggal').val('<?=$report['tanggal_kejadian'];?>');
                                                    $('#report_waktu').val('<?=$report['waktu_kejadian'];?>');
                                                    $('#report_lapor').val('<?=$report['lapor_pihak_terkait'];?>');
                                                   
                                                    $('#report_status').val('<?=$report['status_pelapor'];?>');
													$('#status_laporan').val('<?=$report['status_laporan'];?>');
													
                                                    $('#FormUpdateBox').modal('show');">
                                                    <i class="ri-pencil-line"></i>
                                                </a>
												<!-- $('#report_longitude').val('<?=$report['longitude'];?>');
                                                    $('#report_latitude').val('<?=$report['latitude'];?>');-->
												
                                                <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="Delete" type="button"
															 onclick="$('#dreport_id').val('<?=$report['id_laporan'];?>');
																	  $('#dreport_name').val('<?=$report['full_name'];?>');
																	  $('#dreport_email').val('<?php echo $data['datalogin']["email"]; ?>');
																	  $('#dreport_nik').val('<?php echo $data['datalogin']["nik"]; ?>');
  ...
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo APP_PATH; ?>/report/update" method="post">
			<div class="mb-3 mt-3"> 
				<input type="text" class="form-control" id="report_id" name="report_id" style="display: none;">
				<input type="text" class="form-control" id="report_judul" placeholder="Enter Title" name="report_judul" >
			</div>
			<div class="mb-3 mt-3">  
				<input type="text" class="form-control" id="report_desc" placeholder="Enter Description" name="report_desc" >
			</div>
			<!--
			<div class="mb-3 mt-3"> 
				<input type="text" class="form-control" id="report_longitude" placeholder="Enter Longitude" name="report_longitude">
			</div>
			<div class="mb-3 mt-3"> 
				<input type="text" class="form-control" id="report_latitude" placeholder="Enter Latitude" name="report_latitude">
			</div>
			-->
			<div class="mb-3 mt-3">  
				<input type="text" class="form-control" id="report_lokasi" placeholder="Enter Lokasi" name="report_lokasi" >
			</div>
			<div class="mb-3 mt-3"> 
				<input type="date" class="form-control" id="report_tanggal" placeholder="Enter tanggal" name="report_tanggal" >
			</div> 
			<div class="mb-3 mt-3"> 
				<input type="time" class="form-control" id="report_waktu" placeholder="Enter waktu" name="report_waktu" >
			</div> 
			<div class="mb-3 mt-3"> 
				<input type="text" class="form-control" id="report_lapor" placeholder="Lapor pihak terkait" name="report_lapor" >
			</div>
			<div class="mb-3 mt-3">
				<input type="file" class="form-control" id="report_foto" name="report_foto" accept=".jpg,.jpeg,.png,.gif" capture>
			</div>
			<div class="mb-3 mt-3"> 
				<input type="text" class="form-control" id="report_status" placeholder="Input Status Pelapor" name="report_status" >
			</div>
			 
			<div class="mb-3 mt-3"> 
				<select class="form-control" id="report_status_laporan" name="report_status_laporan">
...
<div class="modal" id="FormDeleteBox">
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
    <div class="modal-content">
      ...
      <!--  Modal body -->
      <div class="modal-body">
        <form action="<?php echo APP_PATH; ?>/report/delete" method="post">
			<div class="mb-3 mt-3"> 
			...
			<div class="mb-3 mt-3"> 
				<input type="text" class="form-control" id="dreport_email" placeholder="Enter Email" name="dreport_email" readonly>
			</div>
			<div class="mb-3 mt-3"> 
				<input type="text" class="form-control" id="dreport_nik" placeholder="Enter NIK" name="dreport_nik" readonly>
			</div>
			<div class="mb-3 mt-3"> 
